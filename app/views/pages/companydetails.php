...
<body onload='initMap()'>
    <div class="content-wrapper">
        <div class="row" style='padding-left:20px'>
            <div class='col-md-6'>
                <h3 style='color:orange'>COMPANY DETAILS</h3>
            </div>
        ...
        <div class='row' style='padding:5px'>
            ...
            <div class='col-md-6'>
                ...
                if (isset($_SESSION["success"])) {
                    ...
                    echo "<center><a href='$urlpath'><span class='btn btn-success form-control'>Check Out Info</span></a><center>";
                }
                    ...
                    <form action="" method="post">
                        ...
                        <div id="tabs-1">
                            ...
                            <table width="100%" class='table table-condensed' style="font-size:13px; font-family:Verdana, Geneva, sans-serif">
                                ...
                                <tr>
                                    ...
                                    <td class="afteritem">
                                        <select name="businesstype" class="form-control" id='accountype'>
                                ...
                                <tr>
                                    ...
                                    <td class="afteritem"><input readonly value="<?php echo $data->recordObject->businessname ?>" type="text" name="businessname" class="tx_businness" id="businessname" style="width:100%" /></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="afteritem">
                                        <input readonly value="<?php echo $data->recordObject->tinnumber ?>" type="text" class="tx_businness" name="tin" id="tin" style="width:100%" />
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="afteritem"> <input readonly value="<?php echo $data->recordObject->natureofbusiness ?>" type="text" class="tx_businness" name="natureofbusiness" id="natureofbusiness" style="width:100%" />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="afteritem">
                                        <input readonly value="<?php echo $data->recordObject->telephone ?>" type="text" name="telephone" class="tx_businness" id="telephone" style="width:100%" />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="afteritem">
                                        <input readonly value="<?php echo $data->recordObject->telephone ?>" type="text" name="telephone" class="tx_businness" id="atelephone" style="width:100%" />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="afteritem">
                                        ...
                                        <input readonly value="<?php echo $data->recordObject->email ?>" type="text" name="businessemail" class="tx_businness" id="businessemail" style="width:100%" />
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="afteritem">
                                        ...
                                        <input readonly value="<?php echo $data->recordObject->website ?>" type="text" name="website" class="tx_businness" id="website" style="width:100%" />
                                    </td>
                                </tr>
                        ...
                        <div id='tabs-5'>
                            <table class='table table-condensed' width="100%" style="font-size:13px; font-family:Verdana, Geneva, sans-serif">
                                ...
                                <tr>
                                    <td><button class='btn btn-success btn-sm' id='submitinfo'><i class='fa fa-save'></i>
                                            Save Data</button></td>
                                </tr>
