...
tr td{
 ...
 .pinput{
  ...
  <div id="tabs-1">
                  ...
                  tyle="font-size:13px; font-family:Verdana, Geneva, sans-serif">
                    ...
                    <tr>
                      ...
                      <td class="afteritem">
                      <select class="form-control" id='accountype'>
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <td class="afteritem"> <input type="text" class="tx_businness"  
                      id="natureofbusiness"  style="width:100%" />
                      </td>
                      </tr>
          ...
          <table class='table table-condensed' width="100%" style="font-size:13px; font-family:Verdana, Geneva, sans-serif">
                    ...
                    <tr>
                     ...
                     <tr>
                      ...
                      <td align='left'>
                       <button class="btn btn-primary btn-sm" id='secondbtn'>Next</button>
                      </td>
                      </tr>
        ...
        <table class='table' width="100%" border="0" cellpadding="2" cellspacing="0" style="font-size:13px; font-family:Verdana, Geneva, sans-serif">
                    ...
                    <tr>
                      ...
                      <td align='left'>
                       <button class="btn btn-primary btn-sm" id='thirdbtn'>Next</button>
                      </td>
                      </tr>
  ...
  <table>
    <tr>
      <td><button class='btn btn-danger btn-sm' id='back3'>Back</button></td>
      <td><button class='btn btn-success btn-sm' id='fourbtn'> Next</button></td>
    </tr>
    </table>  
 </div>
...
var accountsemail = $('#accountsemail').val();
     ...
     $.ajax({
              type: "POST",
              url: "../ajaxscripts/savesabusiness.php",
              data:{city:city,street:street, latitude:latitude, longitude:longitude,
                   ...
                   businessname:businessname, businessemail:businessemail, tin:tin,
                   telephone:telephone, website:website, accounttype:accounttype,
                   businesstype:businesstype, businesscategory:businesscategory, revenue:revenue,
                   numberofemployees:numberofemployees, numberofbranches:numberofbranches,
