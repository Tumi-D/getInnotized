...
tr td{
 ...
 .pinput{
  ...
  <div class="content-wrapper"
   style="background:url('<?php //echo URLROOT ?>/img/insurance_solution_lrge3.jpg');
    background-size:cover;rgba(0,0,0,.5);height:100%">
  <div class="row" style='padding-left:20px'> 
  <div class='col-md-6'><h3 style='color:orange'>SUMMARY OF TRANSACTIONS</h3></div>
  ...
  <hr style='background:#fff'/>
    ...
    <div class="container-fluid main_container">
      ...
      <div class="row" style="margin-bottom:10px">
        ...
        <table class='table table-bordered table-condensed' style='color:#fff;font-size:13px'>
        ...
        <td style='color:#fafafa;'><?php //echo $get->amount   ?></td>
      ...
      <td></td>
      <td></td>
      <td style='color:#fafafa;'>Total</td>
      <td style='color:#fafafa;'><?php //echo $total   ?></td>
      <td></td>
      </tr>
