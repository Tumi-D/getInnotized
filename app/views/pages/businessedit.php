...
$.ajax({
              type: "POST",
              url: "ajaxscripts/configureservice.php",
              data:{id:id},
              dataType: "html",
              beforeSend: function(){
              $.blockUI();
  ...
  <div class="list-group border-bottom" style="padding:5px; height: 680px; overflow-y: scroll">
    ...
    <p>&nbsp</p>
     ...
     <div class="list-group border-bottom" style="padding:5px; ">
       ...
       <a href="#" class="list-group-item" ><span class="fa fa-cog"></span>Activate Account</a>
       <a href="#" class="list-group-item" ><span class="fa fa-cog"></span>Block Account</a>
