...
<head>
    ...
    <link rel="icon" href=<?php echo URLROOT ?>img/favicon.ico>
...
<script src=<?php echo URLROOT ?>vendor1/js/jquery.min.js> </script>
            ...
            <div class='col-md-4'>
                <div class="list-group border-bottom" style="padding:5px; height: 680px; overflow-y: scroll">
                            ...
                            <div class="tab-pane" id="3a">
                                <table class='table table-condensed' width="100%" style="font-size:13px; font-family:Verdana, Geneva, sans-serif">
                                    ...
                                    <tr>
                                        ...
                                        <td class="afteritem">
                                            <?php //echo $bus['AVERAGEREVENUE'] ?>
                                    </tr>

                                    <tr>
                                        <td><span class='alabel'>Number of employees</span></td>
                                        <td class="afteritem">
                                            <?php //echo $bus['NUMBEROFEMPLOYEES'] ?>
                                        </td>
                                    </tr>
                    ...
                    <div class="list-group border-bottom" style="padding:5px; ">
                        ...
                        <a href="#" class="list-group-item terminal"><span class="fa fa-cog"></span> Manage Terminal </a>
                        <a href="#" class="list-group-item access"><span class="fa fa-cog"></span>Administer Privileges </a>
