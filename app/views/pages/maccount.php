...
// $getbilling = $ucon->query("Select * from BILLING where BUSINESSUID = '$businessuid' ");
...
<div class="content-wrapper">
  <!-- style="background:url('<?php //echo URLROOT 
                              ?>/img/insurance_solution_large3.jpg'); background-size:cover;rgba(0,0,0,.5);height:100%;" -->
          ...
          <div id="stabs">
            ...
            <div id="tabs-2" style='' class='userarea'>
              <table class='table table-bordered table-condensed transact' width='100%' style='font-size:12px'>
                ...
                <tr>
                  <td><a target='_blank' href='agentdetails.php?uniqueuid=<?php //echo $unid  
                                                                          ?>'><?php  //echo $b['BUSINESSNAME']  
                                                                              ?></a></td>
                  <td><?php  //echo $b['PHONENUMBER']  
                      ?></td>
