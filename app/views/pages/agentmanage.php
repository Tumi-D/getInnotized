            ...
            <table class='table table-condensed' width="100%" style="font-size:13px; font-family:Verdana, Geneva, sans-serif">
             ...
             <tr class='info'>
                   ...
                   <td colspan="2">LOCATION INFORMATION</td>
                    ...
                    <tr>
                    <td class="afteritem"><input type="text" id="popularname"  placeholder="Popular Name" style="width:100%" /></td>
                     <td class="afteritem"> <input type="text" id="buildingno" placeholder="House / Building No"  style="width:100%" /> </td>
                    ...
                    <td class="afteritem"> <input type="text" placeholder="Street Address"   id="street"  
                      value = '<?php //echo $street  ?>' style="width:100%" /></td>
                        <td class="afteritem"><input type="text" placeholder="City"  id="city"  style="width:100%"  
                          value = '<?php //echo $city  ?>' /></td> 
                   </tr>

                    <tr>
                    <td class="afteritem"><input type="text"  id="assembly" placeholder="Assembly"  style="width:100%" /></td>
        ...
        <div class="g3">
          ...
          <div style="height: 300px; overflow-y: scroll;">
           ...
           <table class='table table-condensed' width="100%" style="font-size:12px; font-family:Verdana, Geneva, sans-serif">
            ...
            //  while($get = $getitems->fetch(PDO::FETCH_ASSOC))
            //   {
